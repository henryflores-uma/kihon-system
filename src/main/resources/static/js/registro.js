document.addEventListener("DOMContentLoaded", function () {
    ...
    function inicializarFormularioRegistro(
        ...
        const modo =
            opciones.modo || "pagina";

        const alCrearUsuario =
            opciones.alCrearUsuario || null;
        ...
        if (
            ...
            console.error(
                "El formulario de registro está incompleto."
            );
        ...
        registroForm.addEventListener(
            ...
            async function (event) {
                ...
                try {
                    ...
                    /*
                     * En modo modal se utiliza
                     * la autenticación del administrador.
                     *
                     * En modo página el endpoint
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                typeof alCrearUsuario ===
                                "function"
                            ) {

                                await alCrearUsuario(
                                    usuario
                                );
